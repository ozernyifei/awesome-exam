...
INSERT INTO Product (Title, InStock, Price)
VALUES 
  ('Laptop', 50, 999.99),
...
VALUES 
  ...
  (6, 6, '2023-05-06 15:00:00', 799.99),
  (7, 7, '2023-05-07 16:20:00', 349.99),
  (8, 9, '2023-05-08 17:10:00', 99.99),
  (9, 8, '2023-05-09 18:25:00', 459.99),
  (10, 10, '2023-05-10 19:40:00', 259.99);
...
CREATE TRIGGER TG_CostChange
ON Product
AFTER UPDATE
AS
INSERT INTO HistoryProduct (ProductID, OldPrice, NewPrice)
SELECT 
FROM inserted, deleted
go;

BACKUP DATABASE exam_test
TO DISK = 'D:\backup.bak'
GO

RESTORE DATABASE exam_test
